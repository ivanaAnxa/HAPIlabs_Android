...
public class JsonRegisterDeviceResponseHandler extends JsonDefaultResponseHandler {
    ...
    public JsonRegisterDeviceResponseHandler(Handler handler) {
        super(handler);
    ...
    public void start() {
        ...
        try {
            ...
            System.out.println("JsonRegisterDeviceResponseHandler: " + strJson);
