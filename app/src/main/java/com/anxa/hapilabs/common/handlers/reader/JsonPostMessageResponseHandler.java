...
/**
 * Created by aprilanxa on 6/1/2016.
 */
public class JsonPostMessageResponseHandler extends JsonDefaultResponseHandler {
    ...
    public JsonPostMessageResponseHandler(Handler handler, String strJson) {
        super(handler);
    ...
    public void start() {
        ...
        try {
            ...
            System.out.println("JsonPostMessageResponseHandler " + strJson);
            ...
            if (jsonResponse.has("api_response")) {
                ...
                if (requestStatus.equalsIgnoreCase("Successful")) {
                    ...
                    setResultMessage(messageObj.optString("message_id"));
