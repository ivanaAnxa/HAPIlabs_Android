 ...
 */
public class JsonGetWorkoutResponseHandler extends JsonDefaultResponseHandler
{
    ...
    public JsonGetWorkoutResponseHandler(Handler handler)
    {
        super(handler);
    ...
    public void start()
    {
        try {
            ...
            System.out.println("JsonGetWorkoutResponseHandler: " + jsonResponse);
