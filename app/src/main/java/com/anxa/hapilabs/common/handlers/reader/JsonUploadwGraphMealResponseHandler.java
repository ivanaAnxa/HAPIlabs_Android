...
import com.anxa.hapilabs.models.MealResposeWithGraph;
 ...
 * request
 */
public class JsonUploadwGraphMealResponseHandler extends JsonDefaultResponseHandler {
    ...
    public JsonUploadwGraphMealResponseHandler(Handler handler) {
        super(handler);
    ...
    public void start() {
        ...
        try {
            ...
            MealResposeWithGraph objResponse = new MealResposeWithGraph();
