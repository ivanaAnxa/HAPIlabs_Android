 ...
 */
public class JsonGetHapiMomentResponseHandler extends JsonDefaultResponseHandler{
    ...
    public JsonGetHapiMomentResponseHandler(Handler handler)
    {
        super(handler);
    ...
    public void start()
    {
        try {
            ...
            System.out.println("JsonGetHapiMomentResponseHandler " + strJson);
            ...
            try {
                ...
                HapiMoment hapiMomentObj = JsonUtil.getHapiMoment(json);

                //transfer the message obj to the response handler
                setResponseObj(hapiMomentObj);
